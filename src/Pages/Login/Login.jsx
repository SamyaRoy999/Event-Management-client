...
const Login = () => {
  const { googleLogin, signInUser, anonymouslyUser } = useContext(AuthContext);
  ...
  const onSubmit = (data) => {
    ...
    signInUser(email, password)
      ...
      .catch(() => {
        toast.error(
          "The email and password do not match our records. Please try again."
        );
      });
  };
          ...
          <div className="text-white">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mt-8 flex justify-center text-lg text-black">
                <button
                  type="submit"
                  className="rounded-3xl bg-[#90B0B7] bg-opacity-50 px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-yellow-600"
                >
                  Login
                </button>
              </div>
            ...
            <div className=" flex justify-center  gap-4 py-2">
              ...
              <a
                className="rounded-3xl  flex items-center gap-2 border-none bg-[#90B0B7] bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md"
                onClick={() => hendelSocial(anonymouslyUser)}
                role="button"
                data-twe-ripple-init
                data-twe-ripple-color="light"
              >
            ...
            <p>
              ...
              <Link to="/register" className=" text-[#90B0B7]">
                Register
              </Link>
            </p>
          </div>
